...
/*
    Q1) Implemente um programa que, infinitamente receba
    como parâmetro de entrada, um número n e retorne os n 
    primeiros números primos existentes. Seu programa para
